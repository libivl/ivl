...
#ifndef IVL_ARRAY_DETAILS_MASK_ARRAY_HPP
#define IVL_ARRAY_DETAILS_MASK_ARRAY_HPP

namespace ivl {

template<class A, class B>
class mask_array
: public array<typename A::elem_type, data::mask<A, B> >
{
public:
	typedef mask_array this_type;
	...
	mask_array() { }
	mask_array(const this_type& o) : base_class(o.base()) { }
	mask_array(const tuple<A&, const B&>& t)
...
#endif // IVL_ARRAY_DETAILS_MASK_ARRAY_HPP
