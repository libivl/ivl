...
#ifndef IVL_LINA_DETAILS_IVL_LAPACK_HPP
#define IVL_LINA_DETAILS_IVL_LAPACK_HPP

// need to include the types, if they are not included
...
/* Here are all the clapack function declarations */

#ifdef IVL_ADD_ALL_CLAPACK_DECLARATIONS
...
#endif // LINA_DETAILS_IVL_LAPACK_HPP
