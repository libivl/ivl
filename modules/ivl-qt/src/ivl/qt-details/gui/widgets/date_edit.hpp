...
#ifndef IVL_QT_GUI_WIDGETS_DATE_EDIT_HPP
#define IVL_QT_GUI_WIDGETS_DATE_EDIT_HPP
...
class _ivlqt_export_ date_edit : public QDateEdit,
	public widget_base <date_edit>,
	public method_binder <date_edit, QDateEdit>
{
	Q_OBJECT
	typedef QDateEdit T;
...
//-----------------------------------------------------------------------------
	...
	explicit date_edit(QWidget* parent = 0) :
		QDateEdit(parent) { init(); }

	explicit date_edit(const QDate& date, QWidget* parent = 0) :
		QDateEdit(date, parent) { init(); }
...
using qt_details::date_edit;

//-----------------------------------------------------------------------------

}  // namespace ivl

#endif  // IVL_QT_GUI_WIDGETS_DATE_EDIT_HPP
