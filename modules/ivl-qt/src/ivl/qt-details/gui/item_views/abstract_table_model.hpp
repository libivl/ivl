...
#ifndef IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_TABLE_MODEL_HPP
#define IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_TABLE_MODEL_HPP
...
class _ivlqt_export_ abstract_table_model : public QAbstractTableModel,
	public method_binder <abstract_table_model, QAbstractTableModel>
{
	Q_OBJECT
	typedef QAbstractTableModel T;
...
//-----------------------------------------------------------------------------
	...
	explicit abstract_table_model(QObject* parent = 0) :
		QAbstractTableModel(parent) { init(); }
...
using qt_details::abstract_table_model;

//-----------------------------------------------------------------------------

}  // namespace ivl

#endif  // IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_TABLE_MODEL_HPP
