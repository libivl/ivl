...
#ifndef IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_ITEM_MODEL_HPP
#define IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_ITEM_MODEL_HPP
...
class _ivlqt_export_ abstract_item_model : public QAbstractItemModel,
	public method_binder <abstract_item_model, QAbstractItemModel>
{
	Q_OBJECT
	typedef QAbstractItemModel T;
...
//-----------------------------------------------------------------------------
	...
	explicit abstract_item_model(QObject* parent = 0) :
		QAbstractItemModel(parent) { init(); }
...
using qt_details::abstract_item_model;

//-----------------------------------------------------------------------------

}  // namespace ivl

#endif  // IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_ITEM_MODEL_HPP
