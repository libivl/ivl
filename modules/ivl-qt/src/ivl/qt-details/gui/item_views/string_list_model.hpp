...
#ifndef IVL_QT_GUI_ITEM_VIEWS_STRING_LIST_MODEL_HPP
#define IVL_QT_GUI_ITEM_VIEWS_STRING_LIST_MODEL_HPP
...
class _ivlqt_export_ string_list_model : public QStringListModel,
	public method_binder <string_list_model, QStringListModel>
{
	Q_OBJECT
	typedef QStringListModel T;
...
//-----------------------------------------------------------------------------
	...
	explicit string_list_model(QObject* parent = 0) :
		QStringListModel(parent) { init(); }

	string_list_model(const QStringList &strings, QObject *parent = 0) :
		QStringListModel(strings, parent) { init(); }
...
using qt_details::string_list_model;

//-----------------------------------------------------------------------------

}  // namespace ivl

#endif  // IVL_QT_GUI_ITEM_VIEWS_STRING_LIST_MODEL_HPP
