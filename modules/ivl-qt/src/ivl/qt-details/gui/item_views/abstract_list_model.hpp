...
#ifndef IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_LIST_MODEL_HPP
#define IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_LIST_MODEL_HPP
...
class _ivlqt_export_ abstract_list_model : public QAbstractListModel,
	public method_binder <abstract_list_model, QAbstractListModel>
{
	Q_OBJECT
	typedef QAbstractListModel T;
...
//-----------------------------------------------------------------------------
	...
	explicit abstract_list_model(QObject* parent = 0) :
		QAbstractListModel(parent) { init(); }
...
using qt_details::abstract_list_model;

//-----------------------------------------------------------------------------

}  // namespace ivl

#endif  // IVL_QT_GUI_ITEM_VIEWS_ABSTRACT_LIST_MODEL_HPP
