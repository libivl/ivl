...
_ivlqt_export_ slot <void ()> application::quit;
_ivlqt_export_ slot <void ()> application::close_all_windows;
_ivlqt_export_ slot <void ()> application::about_qt;
